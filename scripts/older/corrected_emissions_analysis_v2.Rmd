...
# Load house profile data - EXPECTS house_profile object from separate component script
# If not available, generate mock data structure for analysis
if (!exists("house_profile")) {
  ...
  warning("Using mock house_profile data - upload house component script first for actual data")
}
```
