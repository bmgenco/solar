...
```{r}
 #Debug the working directory setup
raw_data <- read.csv("data/C9CD28-Ridgedale_electrical_meter-1DAY.csv", stringsAsFactors = FALSE)
cat("Raw CSV dimensions:", nrow(raw_data), "x", ncol(raw_data), "\n")
cat("Column names:\n")
print(names(raw_data))
cat("First few rows:\n")
print(head(raw_data, 3))
cat("First column sample:\n")
