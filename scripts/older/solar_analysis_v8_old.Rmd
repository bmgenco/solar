...
emporia_file <- file.path(data_dir, "emporia_data.csv")
ecobee_folder <- ecobee_dir
ga_power_energy_file <- file.path(data_dir, "ENERGY_GPC_Usage_file.xlsx")
ga_power_cost_file <- file.path(data_dir, "COST_GPC_Usage_file.xlsx")
ga_power_bills_file <- file.path(data_dir, "ga_power_bills.csv")
gas_usage_file <- file.path(data_dir, "GAS_bmgenco.csv")
...
emporia_file<-"C9CD28-Ridgedale_electrical_meter-1DAY.csv"
