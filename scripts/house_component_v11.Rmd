...
ecobee_dir <- file.path(wd, "data", "ecobee")
...
function_variables$installer_system <- list(
  ...
  battery_usable_capacity_kwh = 8.5,
  # battery_output_kw = 3.84, # single battery
  battery_output_kw = 7.68,  # 2x 3.84kW continuous (parallel operation)
  battery_cost = 11349, # $
  battery_mode = "energy_arbitrage", # Time-of-use optimization
  # battery_backup_allocation = 0, # % (configured for arbitrage, not backup)
  battery_backup_allocation = 15,  # % minimum SOC for cold weather safety (LFP temp margin)
